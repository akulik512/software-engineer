package org.akulik.designpatterns.composite;
...
class Composite {
  ...
  private MenuComponent given_dinerMenu() {
    ...
    dinerMenu.add(
        new MenuItem(
            "Soup of the day",
            "(Fakin') A bowl of the soup of the day, with a side of potato salad",
            false,
            3.29));
    dinerMenu.add(
        new MenuItem(
    ...
    dinerMenu.add(
        new MenuItem(
            ...
            true,
            3.89));
    dinerMenu.add(new MenuItem("Pasta", "Steamed vegetables over brown rice", false, 3.99));
  ...
  private MenuComponent given_masterMenu(
      MenuComponent pancakeHouseMenu, MenuComponent dinerMenu, MenuComponent cafeMenu) {
